    ...
    return (
      <div>
        <h2 id="project-heading">
          <Translate contentKey="jhipDefectTrackerApp.project.home.title">Projects</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipDefectTrackerApp.project.home.createLabel">Create a new Project</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {projectList && projectList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="jhipDefectTrackerApp.project.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipDefectTrackerApp.project.home.notFound">No Projects found</Translate>
            </div>
          )}
        </div>
