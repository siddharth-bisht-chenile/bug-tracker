...
export class Ticket extends React.Component<ITicketProps, ITicketState> {
  state: ITicketState = {
    ...
    return (
      <div>
        <h2 id="ticket-heading">
          ...
          <Link to={`${match.url}/self`} className="btn btn-primary float-right flex-btn-group-container" id="my-tickets">
            <Translate contentKey="jhipDefectTrackerApp.ticket.home.myTicketsLabel">My Tickets</Translate>
          </Link>
