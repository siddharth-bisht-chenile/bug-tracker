...
export class Label extends React.Component<ILabelProps, ILabelState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="label-heading">
          <Translate contentKey="jhipDefectTrackerApp.label.home.title">Labels</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipDefectTrackerApp.label.home.createLabel">Create a new Label</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {labelList && labelList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('label')}>
                    <Translate contentKey="jhipDefectTrackerApp.label.label">Label</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipDefectTrackerApp.label.home.notFound">No Labels found</Translate>
            </div>
          )}
        </div>
