...
export class LabelUpdate extends React.Component<ILabelUpdateProps, ILabelUpdateState> {
  ...
  render() {
    const { labelEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipDefectTrackerApp.label.home.createOrEditLabel">
              <Translate contentKey="jhipDefectTrackerApp.label.home.createOrEditLabel">Create or edit a Label</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : labelEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="labelLabel" for="label-label">
                    <Translate contentKey="jhipDefectTrackerApp.label.label">Label</Translate>
                  </Label>
                  <AvField
                    id="label-label"
                    type="text"
